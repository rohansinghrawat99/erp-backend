export class HttpException extends Error {
     ...
     *
     * It should be directly addressed to employee
     * as in most cases this will be displayed to employee.
     */
    message: string;
     ...
     * and using which frontend should redirect employee back to the previous page
     */
    errorCode: number;
...
export enum ApiErrorCode {
    ...
    // EMPLOYEE Related
    EMPLOYEE_NOT_FOUND = 101,
    EMPLOYEE_ALREADY_REGISTERED = 102,
    EMPLOYEE_DEACTIVATED = 103,
    WRONG_PASSWORD = 104,
    CANNOT_DELETE_SELF = 105,
    ROLE_NOT_ASSIGNED = 106,
    INVITATION_NOT_FOUND = 107,
